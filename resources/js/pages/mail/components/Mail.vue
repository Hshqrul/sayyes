...
import MailListDisplay from './MailListDisplay.vue'
    ...
    <div class="hidden md:block">
        <TooltipProvider :delay-duration="0">
            <ResizablePanelGroup id="resize-panel-group-1" direction="horizontal"
                class="h-full max-h-[780px] items-stretch">
        ...
        <aside>
            <TooltipProvider :delay-duration="0">
                <div class="flex items-center justify-center px-2 py-4">
                    <AccountSwitcher :is-collapsed="true" :accounts="accounts" />
                </div>
                <Separator />
                <Nav :is-collapsed="true" :links="links" />
                <Separator />
                <Nav :is-collapsed="true" :links="links2" />
            </TooltipProvider>
        </aside>
        <Tabs default-value="all" class="flex-1">
            ...
            <Separator />
            <div class="bg-background/95 px-4 py-1.5 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                <form>
                    <div class="relative">
                        <Search class="absolute left-2 top-2.5 size-4 text-muted-foreground" />
                        <Input v-model="searchValue" placeholder="Search" class="pl-8" />
